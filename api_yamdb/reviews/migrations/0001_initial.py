    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Имя пользователя', max_length=150, unique=True, validators=[reviews.validators.username_validator, reviews.validators.pattern_validator], verbose_name='Пользователь')),
