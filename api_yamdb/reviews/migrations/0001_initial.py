# Generated by Django 3.2 on 2023-04-09 17:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Имя пользователя', max_length=200, unique=True, verbose_name='Пользователь')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ManyToManyField(help_text='Укажите жанр произведения', related_name='titles', to='reviews.Genre', verbose_name='Жанр')),
            ],
            options={
